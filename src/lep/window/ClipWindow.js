/**
 * Represents a knockout-enhanced, windowed view on clips (i.e. a matrix of tracks and scenes).
 *
 ...
 * @constructor
 */
lep.ClipWindow = lep.util.extendClass(lep.TrackWindow, {
    _init: function(name, numTracks, numSends, numScenes, trackBank) {
        lep.util.assertNumberInRange(numScenes, 1, lep.TrackWindow.MAX_SCENES, 'Invalid numScenes={} for ClipWindow {}', numScenes, name);
        ...
        /**
         * Generates a ControlSet instance that fits all launcherSlots of this ClipWindow.
...
/**
 * Creates a ClipWindow instance with a main track bank.
 * @param numTracks {Number}
 * @param numSends {Number}
 * @param numScenes {Number}
 * @static
 */
lep.ClipWindow.createMain = function(numTracks, numSends, numScenes) {
    return new lep.ClipWindow('MainClipWindow', numTracks, numSends, numScenes);
};